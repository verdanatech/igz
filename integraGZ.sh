...
sleep 1
	...
	tar -zxvf glpi-certificates-2.2.0.tar.gz
	...
	tar -zxvf glpi-domains-1.8.0.tar.gz
	...
	tar -zxvf glpi-resources-2.3.0.tar.gz
	...
	tar -zxvf glpi-webapplications-2.3.0.tar.gz
