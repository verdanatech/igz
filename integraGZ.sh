	...
	case $VERSION_ID in
		...
		7)
			...
			then
				...
				whiptail --title "${TITULO}" --backtitle "${BANNER}" --msgbox "We apologize!\nThis script was developed for:\nCentOS 7, Debian 8 and 9 and Ubuntu 16.\nWe will close the running now." --fb 15 50
				kill $$
